const responseCodes = {
  ...
  HEALTH_METRICS_SUCCESS: 93,
  HEALTH_METRICS_ERROR: 193,
  HEALTH_TIME_SUCCESS: 96,
  HEALTH_TIME_ERROR: 196,
  HEALTH_RESOURCES_SUCCESS: 98,
  HEALTH_RESOURCES_ERROR: 198,
  HEALTH_SENDER_STATE_SUCCESS: 99,
  HEALTH_SENDER_STATE_ERROR: 194,
...
const responseMessages = {
  ...
  HEALTH_METRICS_SUCCESS: "Sender metrics snapshot success",
  HEALTH_METRICS_ERROR: "Sender metrics snapshot error",
  ...
  HEALTH_SENDER_STATE_SUCCESS: "Sender state snapshot success",
  HEALTH_SENDER_STATE_ERROR: "Sender state snapshot error",
